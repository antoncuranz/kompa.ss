    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "sm:max-w-[425px] max-h-[calc(100%-4rem)] max-sm:h-full flex flex-col p-2 border-0 dark:border shadow-xl shadow-black/10 dark:shadow-white/5 rounded-3xl", // customization
          className
        )}
        {...props}
      >
