  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "cursor-pointer data-[size=default]:h-10 shadow-input border-none focus-visible:ring-2 focus-visible:ring-neutral-400 dark:focus-visible:ring-neutral-600 bg-gray-50 px-4 font-medium dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_#262626]", //  customization (remove shadow-* above)
        className,
      )}
      {...props}
    >
    ...
    <>
      ...
      <SelectPrimitive.Popup
        ...
        className={cn(
          ...
          "border-0 dark:border shadow-lg shadow-black/10 dark:shadow-white/5 ", // customization
          className,
        )}
        {...props}
      >
